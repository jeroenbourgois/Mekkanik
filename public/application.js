...
module.exports = jQuery;}, "spine/index": function(exports, require, module) {module.exports = require('./lib/spine');}, "spine/lib/spine": function(exports, require, module) {(function() {
...
}, "controllers/contacts": function(exports, require, module) {(function() {
  var $, Contact, Contacts, Main, Manager, Sidebar, Spine;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  Contacts = (function() {
    ...
    Contacts.prototype.className = 'contacts';
    function Contacts() {
      var divide;
      ...
      this.main = new Main;
      this.routes({
        '/contacts/:id/edit': function(params) {
          this.sidebar.active(params);
          return this.main.edit.active(params);
        },
        '/contacts/:id': function(params) {
          this.sidebar.active(params);
          return this.main.show.active(params);
        }
      });
...
}, "controllers/contacts.main": function(exports, require, module) {(function() {
  var $, Contact, Edit, Main, Show, Spine;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  Show = (function() {
    ...
    Show.prototype.className = 'show';
    Show.prototype.events = {
      'click .edit': 'edit'
    };
    function Show() {
      this.change = __bind(this.change, this);      Show.__super__.constructor.apply(this, arguments);
      this.active(this.change);
    }
    Show.prototype.render = function() {
      return this.html(require('views/show')(this.item));
    };
    Show.prototype.change = function(params) {
      this.item = Contact.find(params.id);
      return this.render();
    };
    Show.prototype.edit = function() {
      return this.navigate('/contacts', this.item.id, 'edit');
    };
    return Show;
  })();
  Edit = (function() {
    ...
    function Edit() {
      this.change = __bind(this.change, this);      Edit.__super__.constructor.apply(this, arguments);
      this.active(this.change);
    }
    Edit.prototype.render = function() {
      return this.html(require('views/form')(this.item));
    };
    Edit.prototype.change = function(params) {
      this.item = Contact.find(params.id);
      return this.render();
    };
    Edit.prototype.submit = function(e) {
      ...
      return this.navigate('/contacts', this.item.id);
    };
...
}, "controllers/contacts.sidebar": function(exports, require, module) {(function() {
  var $, Contact, List, Sidebar, Spine;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  Sidebar = (function() {
    ...
    function Sidebar() {
      ...
      this.render = __bind(this.render, this);      Sidebar.__super__.constructor.apply(this, arguments);
      this.html(require('views/sidebar')());
      this.list = new List({
        el: this.items,
      ...
      this.active(function(params) {
        return this.list.change(Contact.find(params.id));
      });
    ...
    Sidebar.prototype.render = function() {
      var contacts;
      contacts = Contact.filter(this.query);
      return this.list.render(contacts);
    };
    Sidebar.prototype.change = function(item) {
      return this.navigate('/contacts', item.id);
    };
    Sidebar.prototype.create = function() {
      var item;
      item = Contact.create();
      return this.navigate('/contacts', item.id, 'edit');
    };
    return Sidebar;
  })();
  ...
  App = (function() {
    ...
    function App() {
      ...
      this.append(this.contacts.active());
      Spine.Route.setup();
    }
    return App;
  })();
...
}, "lib/list": function(exports, require, module) {(function() {
  var $;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
  ...
  Contact = (function() {
    ...
    Contact.filter = function(query) {
      ...
      return this.select(function(item) {
        var _ref, _ref2;
        return ((_ref = item.name) != null ? _ref.toLowerCase().indexOf(query) : void 0) !== -1 || ((_ref2 = item.email) != null ? _ref2.toLowerCase().indexOf(query) : void 0) !== -1;
      });
    };
    return Contact;
  })();
...
}, "views/form": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  ...
  return __out.join('');
}}, "views/item": function(exports, require, module) {module.exports = function(values){ 
  var $  = jQuery, result = $();
  ...
  (function() {
    (function() {
      ...
      __out.push(__sanitize(this.name || "<i>No Name</i>"));
      __out.push('\n</div>');
    }).call(this);
  ...
  return result;
};}, "views/show": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/sidebar": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
